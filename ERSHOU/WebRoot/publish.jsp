...
<body>
	<div class="container">
		<form action="/goodhome/publish!newGood.action" class="form-horizontal" name="form1">
			<h2>商品信息</h2>
			<div class="form-group">
				<label for="name" class="control-label col-sm-2">名称</label>
				<div class="col-sm-10">
					<input type="text" class="form-control" placeholder="恰当的名字更能被检索到" required autofocus>
				</div>
			</div>
			<div class="form-group">
				<label for="abstract" class="control-label col-sm-2">简介</label>
				<div class="col-sm-10">
					<textarea name="abstract" id="abstract" cols="30" rows="4" class="form-control" placeholder="简要介绍一下它的新旧程度吧"required></textarea>
				</div>
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<input type="tel" class="form-control" placeholder="留下电话方便买家联系你">
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-10 ">
					<select name="category" id="department" class="form-control " onchange="chooseMajor()" >
